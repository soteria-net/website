        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <ScrollLink to="tech" spy={true} smooth={true} duration={300} className="cursor-pointer font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out" activeClass="active">Tech</ScrollLink>
              </li>
              <li>
                <ScrollLink to="features" spy={true} smooth={true} duration={300} className="cursor-pointer font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out" activeClass="active">Features</ScrollLink>
              </li>
              <li>
