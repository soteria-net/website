            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  ...
                  <div className={"text-center p-1 px-2 shadow shadow-indigo-500 bg-indigo-100 rounded-full " + (tab == 1 && "invisible")}>
                    <p className='text-xs text-indigo-500'>Click</p>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div className={"text-center p-1 px-2 shadow shadow-indigo-500 bg-indigo-100 rounded-full " + (tab == 2 && "invisible")}>
                    <p className='text-xs text-indigo-500'>Click</p>
                  </div>
                </a>
                <a
                  className={`flex space-x-6 items-end text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${tab !== 3 ? 'bg-white shadow-md border-gray-200 hover:shadow-lg' : 'bg-gray-200 border-transparent'}`}
                  href="#0"
                ...
                >
                  ...
                  <div className={"text-center p-1 px-2 shadow shadow-indigo-500 bg-indigo-100 rounded-full " + (tab == 3 && "invisible")}>
                    <p className='text-xs text-indigo-500'>Click</p>
                  </div>
                </a>
              </div>
