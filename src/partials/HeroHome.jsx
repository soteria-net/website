...
import HeroImage from '../images/dashboard-transformed.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6" id="home">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            {/* <h1 className="text-5xl font-extrabold leading-tighter tracking-tighter mb-4">Learn more at <br/> <span className="text-6xl bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-indigo-500">soteria.netlify.app</span></h1> */}
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              <div className="flex flex-col justify-center">
                <img className="mx-auto rounded-lg shadow-lg" src={HeroImage} width="768" height="432" alt="Hero" />
